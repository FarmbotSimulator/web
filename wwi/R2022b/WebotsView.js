...
export default class WebotsView extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.toolbarCss.href = '/web/wwi/R2022b/css/toolbar.css';
    ...
    this.progressCss.href = '/web/wwi/R2022b/css/progress.css';
  ...
  // bm
  _loadRobots(){
    let robotsUrl = "/robots/robots.json"
    fetch(robotsUrl)
      .then(response => response.text())
      .then(function(data) {
        window.localStorage.setItem("robots", data)        
      })
      .catch(error => {
        console.error(error);
      });
  ...
  _init() {
    ...
    promises.push(this._loadScript('/web/wwi/R2022b/dependencies/assimpjs.js'));
    promises.push(this._loadScript('/web/wwi/R2022b/dependencies/glm-js.min.js'));
    promises.push(this._loadScript('/web/wwi/R2022b/dependencies/quaternion.min.js'));
    promises.push(this._loadScript('/web/wwi/R2022b/enum.js'));
    promises.push(this._loadScript('/web/wwi/R2022b/wrenjs.js'));
    promises.push(this._loadRobots())
  }
