export default class Progress {
  constructor(parentNode, message, image) {
    ...
    this._progressPanelTitle.innerHTML = '<img src="/web/images/logo.png"></img><p>Brian Mechanisms</p>';
    ...
    this._progressPanelSubtitle.innerHTML = 'Robot simulator and controller';
    ...
    this._progressPanelVersion.innerHTML = '';
    ...
    this._progressPanelCopyright.innerHTML = 'Copyright &copy 2022 CSECO.';
  ...
  _setDefaultImage() {
    this._progressImage.src = '/web/wwi/R2022b/images/loading/default_thumbnail.png';
  }
}
